...
# cd SUSYBSMAnalysis/
# voms-proxy-init --voms cms -valid 192:00
# cp /eos/user/l/leyan/CrabHSCP/CMSSW_10_6_30/src/SUSYBSMAnalysis/HSCP/data/CorrFact*Pix*.txt .
# cp /eos/user/l/leyan/CrabHSCP/CMSSW_10_6_30/src/SUSYBSMAnalysis/HSCP/data/template*.root .
# cp /eos/user/l/leyan/CrabHSCP/CMSSW_10_6_30/src/SUSYBSMAnalysis/HSCP/data/MuonTimeOffset.txt .
...
config.JobType.psetName = 'Data_ProducerAnalyzer_submit.py'
config.JobType.allowUndistributedCMSSW = True
config.JobType.inputFiles = ['/eos/user/l/leyan/NewHSCP/CMSSW_10_6_30/src/SUSYBSMAnalysis/HSCP/data/CorrFactEVADPixL1.txt','/eos/user/l/leyan/NewHSCP/CMSSW_10_6_30/src/SUSYBSMAnalysis/HSCP/data/CorrFactEVADPixL2.txt','/eos/user/l/leyan/NewHSCP/CMSSW_10_6_30/src/SUSYBSMAnalysis/HSCP/data/CorrFactEVADPixL3.txt','/eos/user/l/leyan/NewHSCP/CMSSW_10_6_30/src/SUSYBSMAnalysis/HSCP/data/CorrFactEVADPixL4.txt','/eos/user/l/leyan/NewHSCP/CMSSW_10_6_30/src/SUSYBSMAnalysis/HSCP/data/CorrFactEVADPixR1.txt','/eos/user/l/leyan/NewHSCP/CMSSW_10_6_30/src/SUSYBSMAnalysis/HSCP/data/CorrFactEVADPixR2.txt','/eos/user/l/leyan/NewHSCP/CMSSW_10_6_30/src/SUSYBSMAnalysis/HSCP/data/GiTEMPLATE','/eos/user/l/leyan/NewHSCP/CMSSW_10_6_30/src/SUSYBSMAnalysis/HSCP/data/MuonTimeOffset.txt']
...
config.Data.outLFNDirBase = '/store/user/leyan/NewHSCP/CMSSW_10_6_30/src/CCCCCCCCCrab_result'
...
config.Site.whitelist = ['T2_BE_*','T2_ES_*','T2_IN_TIFR','T2_DE_DESY','T2_CH_CERN','T2_IT_*','T1_IT_*','T2_US_*', 'T3_US_FNALLPC','T3_US_*','T2_FR_*', 'T2_UK_*']
