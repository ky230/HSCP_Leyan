...
# defaults
#options.outputFile = '00CADD20-067F-E711-94A4-0025905B859E_2016Data_ToF3.root'
options.outputFile = '2017Data-2.root'
...
print('Data Year     : {}'.format(options.YEAR))
print('Data Era      : {}'.format(options.ERA))
...
process.source = cms.Source("PoolSource",
   #fileNames = cms.untracked.vstring("/store/data/Run2016B/SingleMuon/AOD/07Aug17_ver1-v1/70000/00CADD20-067F-E711-94A4-0025905B859E.root"),
   ...
   fileNames = cms.untracked.vstring("/store/data/Run2018B/SingleMuon/AOD/15Feb2022_UL2018-v1/2430000/019CE241-1E9A-6645-B15D-449487EC0844.root"), 
